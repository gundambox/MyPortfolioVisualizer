...
start_date = prompt_user_input_date()
...
strategies = {
    ...
    "Strategy 5": {"cash-TWD": 0.4, "cash-USD": 0.1, "stock-twii": 0.0, "stock-00631L": 0.4, "stock-SPY": 0.0, "stock-SSO": 0.1}, # 100%
    "Strategy 6": {"cash-TWD": 0.2, "cash-USD": 0.1, "stock-twii": 0.0, "stock-00631L": 0.5, "stock-SPY": 0.2, "stock-SSO": 0.0}, # 120%
    "Strategy 7": {"cash-TWD": 0.3, "cash-USD": 0.2, "stock-twii": 0.0, "stock-00631L": 0.3, "stock-SPY": 0.0, "stock-SSO": 0.2}, # 100%
    "Strategy 8": {"cash-TWD": 0.25, "cash-USD": 0.25, "stock-twii": 0, "stock-00631L": 0.25, "stock-SPY": 0.0, "stock-SSO": 0.25}, # 100%
    "Strategy 9": {"cash-TWD": 0.5, "cash-USD": 0.0, "stock-twii": 0.0, "stock-00631L": 0.5, "stock-SPY": 0.0, "stock-SSO": 0.0}, # 100%
}
...
for strategy, allocation in strategies.items():
    ...
    # Save report to file
    with open(f"{strategy}_report.txt", "w") as f:
        f.write(f"Strategy: {strategy}\n")
        f.write(f"Cumulative Return: {cumulative_return:.2%}\n")
        f.write(f"Annualized Return: {annualized_return:.2%}\n")
        f.write(f"Annualized Standard Deviation: {annualized_std:.2%}\n")
